            ...
            <main className="col-md-10 py-md-3 pl-md-5 bd-content" role="main">
              ...
              <div className="row mb-7 justify-content-end mx-auto">
                <Link to={{
                  ...
                  state: {
                    viewAllProjectsBy: ALL
                  }
                }}>
                  <button type="button" className="btn btn-info btn-lg mr-4" >View all Projects
                  </button>
                </Link>

                <Link to={{ pathname: '/projectmgmt/createproject/' }}>
              ...
              {/* In Progress project cards below */}
              <div className="row mt-5">
                <div className="col-md-8 align-self-start">
                  <h1 className="display-6">Projects in Progress</h1>
                  <Link to={{
                    pathname: '/projectmgmt/projectsearch/',
                    state: {
                      viewAllProjectsBy: INPROGRESS
                    }
                  }}>
              ...
              <div className="container-fluid py-2">
                <div className="d-flex flex-row flex-nowrap overflow-auto">
                {this.entireArrayIsUndefined(projectsInProgress) ? <h2 className="mx-auto mt-5">No projects in progress</h2> :  projectsInProgress }
                </div>
              </div>
              ...
              <div className="container-fluid py-2">
                <div className="d-flex flex-row flex-nowrap overflow-auto">
                {this.entireArrayIsUndefined(projectsPublished) ? <h2 className="mx-auto mt-5">No projects published</h2> : projectsPublished }
                </div>
              </div>
