...
import TeamCards from './TATeamCards';
//css
...
const CreateProject = props => {
    ...
    function handleFileUpload(event) {
        ...
        // axios.post("http://127.0.0.1:5000/api/poster/", data); 
    ...
    async function createProject(e) {
        ...
        fetch('https://api.questumd.com/api/projects', requestOptionsProject).then(res => {
            if (res.ok) {
                res.json().then(project => {
                    alert("Project Submitted Successfully!");
                }).catch(console.log);
                // can route to another page if u want
                props.history.push(`/projectmgmt`)

            } else {
                // error message, make better
                console.log(res)
